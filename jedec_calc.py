...
TESTS = {
    ...
    "htol": {
        ...
        "duration": "168 hrs / 500 hrs / 1000 hrs (3×77 samples)",
        "sample_size": 77,
        "pass_criteria": "0 failures at 90% CL, 90% reliability",
        "pre_testing": "Functional",
        "post_testing": "Functional",
        "destructive": False,
    ...
    "elfr": {
        ...
        "duration": "48 hours",
        "sample_size": 3000,
        "pass_criteria": "Meets FIT rate target",
        "pre_testing": "Functional",
        "post_testing": "Functional",
        "destructive": False,
    ...
    "thb": {
        ...
        "condition": "85°C / 85% RH, Vdd_max",
        "duration": "1000 hrs (3×25 samples)",
        "sample_size": 25,
